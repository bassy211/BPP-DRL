...
def export_json(url, data_url, args, ratios, center_offsets,
    ...
    result_data = {
        ...
        "center_of_mass": {
            ...
            "x_stats": {
                "mean":    float(np.mean(com_xs)) if com_xs else None,
                "std":     float(np.std(com_xs)) if com_xs else None,
                "min":     float(np.min(com_xs)) if com_xs else None,
                "max":     float(np.max(com_xs)) if com_xs else None,
            } if com_xs else None,
            "y_stats": {
                "mean":    float(np.mean(com_ys)) if com_ys else None,
                "std":     float(np.std(com_ys)) if com_ys else None,
                "min":     float(np.min(com_ys)) if com_ys else None,
                "max":     float(np.max(com_ys)) if com_ys else None,
            } if com_ys else None,
        },
        "center_offset": {
