python main.py --mode test --use-cuda --load-model --data-name cut_1.pt --enable-rotation --algorithm a2c --load-name Bpp-v02026.03.03-13-42.pt\
python main.py --mode test --load-model --use-cuda --data-name processed_train.pt --algorithm a2c --enable_rotation --load-name Bpp-v02026.03.05-20-29.pt
